...
import { TYPE_COLORS, CardContainer } from "./PokeDetailsStyled";
        ...
        <div className="col">
          <div className="card-header">
            <div className="row d-flex align-items-7center">
              <div className="col-5">
                <h5>
                  {this.state.pokemonIndex < 10
                    ? "#00" + this.state.pokemonIndex
                    : this.state.pokemonIndex < 100
          ...
          <div className="card-footer text-muted">
            Developed by Cicero Oliveira{" "}
            <a
              href="https://github.com/galter"
